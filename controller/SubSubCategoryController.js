...
const SubSubCategoryController = {
    ...
    async getSubSubCategoryList(req, res) {
        try {
            ...
            res.status(500).send({
                error: 'An error occurred when trying to fetch sub categories.'
            });
        }
    },
    ...
    async createSubSubCategory(req, res) {
        try {
            ...
            res.status(500).send({
                error: 'An error occurred when trying to create a sub sub category.'
            });
        }
    },
    ...
    async updateSubSubCategory(req, res) {
        try {
            ...
            res.status(500).send({
                error: 'An error occurred when trying to update a sub sub category.'
            });
        }
    },
    ...
    async deleteSubSubCategory(req, res) {
        try {
            ...
            res.status(500).send({
                error: 'An error occurred when trying to delete a sub sub category.'
            });
        }
    },
};

export default SubSubCategoryController;
