...
export default {
    async getAllProducts(req, res) {
        try {
            ...
            res.status(500).send({
                error: "An error occurred when trying to fetch the products.",
            });
        }
    },
    async topSellProduct(req, res) {
        try {
            ...
            res.status(500).send({
                error: "An error occurred when trying to fetch top sell products.",
            });
        }
    },
    async newAddProduct(req, res) {
        try {
            ...
            res.status(500).send({
                error: "An error occurred when trying to fetch recently added products.",
            });
        }
    },
    async getRecommendation(req, res) {
        try {
            ...
            res.status(500).send({
                error: "An error occurred when trying to fetch recommended products.",
            });
        }
    },
    async getProductSales(req, res) {
        try {
            ...
            res.status(500).send({
                error: "An error occurred when trying to fetch a product sales.",
            });
        }
    },
    async getProduct(req, res) {
        try {
            ...
            res.status(500).send({
                error: "An error occurred when trying to fetch a product.",
            });
        }
    },
    ...
    async createProduct(req, res) {
        try {
            ...
            res.status(500).send({
                error: 'An error occurred when trying to create a product.'
            });
        }
    },
    async updateProduct(req, res) {
        try {
            ...
            res.status(500).send({
                error: 'An error occurred when trying to update a product.'
            });
        }
    },
    async deleteProduct(req, res) {
        try {
            ...
            res.status(500).send({
                error: 'An error occurred when trying to delete a product.'
            });
        }
    },
};