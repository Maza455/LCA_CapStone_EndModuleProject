...
export default {
    async getOrderItemList(req, res) {
        try {
            ...
            res.status(500).send({
                error: 'An error occurred when trying to fetch the order items.'
            });
        }
    },
    async createOrderItem(req, res) {
        try {
            ...
            res.status(500).send({
                error: 'An error occurred when trying to create an order item.'
            });
        }
    },
    async deleteOrderItem(req, res) {
        try {
            ...
            res.status(500).send({
                error: 'An error occurred when trying to delete an order item.'
            });
        }
    },
};
